...
{
    public partial class DefaultVerticalTemplateContent : TemplateContent, IXafPopupWindowControlContainer, IXafSecurityActionContainerHolder, IHeaderImageControlContainer
    {
        static DefaultVerticalTemplateContent()
        {
