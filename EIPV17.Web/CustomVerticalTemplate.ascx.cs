...
{
    public partial class CustomVerticalTemplate : TemplateContent, IXafPopupWindowControlContainer, IXafSecurityActionContainerHolder, IHeaderImageControlContainer
    {
        static CustomVerticalTemplate()
        {
