...
namespace EIPV17.Module.Win.Templates
{
    public partial class OutlookStyleMainRibbonForm : RibbonForm, IActionControlsSite, IContextMenuHolder, IWindowTemplate, IDockManagerHolder, IBarManagerHolder, ISupportViewChanged, IXafDocumentsHostWindow, ISupportUpdate, IViewSiteTemplate, ISupportStoreSettings, IViewHolder, IOfficeNavigationBarHolder, ITransitionManagerHolder, IPanelCaption
    {
        ...
        public OutlookStyleMainRibbonForm()
        {
            InitializeComponent();
            InitializeImages();
