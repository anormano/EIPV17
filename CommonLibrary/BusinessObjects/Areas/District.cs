...
namespace CommonLibrary.BusinessObjects.Areas
{
   ...
   [RuleCombinationOfPropertiesIsUnique("Code,Province")]
   public class District : XPLiteObject
   { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
      ...
      public XPCollection<SubDistrict> SubDistricts
      {
         get
         {
            return GetCollection<SubDistrict>("SubDistricts");
         }
      }
   }
}